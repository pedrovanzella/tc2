...
Convém salientar que o parâmetro de função de custo só será utilizado para o
agendamento \textit{Simple}. Desta forma, será realizada uma simulação para cada
função de custo.
