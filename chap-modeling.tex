...
o cenário \ref{model:scenario}. Nas linhas 4 a 6, os objetos \textit{observers}
se registram no \textit{notifier} para receberem notificações de eventos. É
...
Building::notify(Event event) {
  ...
  \item[Reagir à chegada de um novo cliente] \hfill \\
    ...
    modo a repopular constantemente as filas de cada andar.
