...
\section{\label{model:scenario}Cenários}

Como entrada, o simulador recebe um conjunto de cenários, definidos no arquivo
de configuração (seção \ref{model:config}) e realiza a simulação dos
...
\section{\label{model:config}Arquivo de Configuração}
