...
\unsure{Capítulo sendo revisado por Taschetto.}
...
sementes (ou seja, o comportamento É determinístico) pode ser considerado
REALMENTE estocástico? (Taschetto)}
...
\subsubsection{\label{chap:sim:timeadvance}Mecanismo de avanço de tempo}
...
\section{\label{sec:simulator:traits}Características do Simulador}
